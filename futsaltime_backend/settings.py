...
ROOT_URLCONF = "futsaltime_backend.urls"
...
WSGI_APPLICATION = "futsaltime_backend.wsgi.application"
...
SPECTACULAR_SETTINGS = {
    "TITLE": "FutsalTime API",
    "DESCRIPTION": "Football field reservation API (Capstone).",
    "VERSION": "1.0.0",
}
